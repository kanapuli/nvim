...
vim.keymap.set('t', '<Esc><Esc>', '<C-\\><C-n>', { desc = 'Exit terminal mode', remap = false, silent = true })
...
vim.api.nvim_create_autocmd('FileType', {
  pattern = { 'diff', 'go', 'py', 'rs', 'lua', 'c', 'java', 'kt', 'sh', 'md' },
  callback = function()
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', ',,', '<C-^>', { desc = 'Go to last buffer' })
